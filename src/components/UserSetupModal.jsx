...
export default function UserSetupModal({ onClose, onUserSet }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="relative bg-gradient-to-br from-violet-950 via-purple-900 to-fuchsia-950 rounded-3xl shadow-2xl shadow-purple-500/30 max-w-md w-full overflow-hidden">
        {/* Decorative elements */}
